...
public class CustomerValidate {
    private static final String REGEXCUSTOMER = "^([\\p{Lu}][\\p{Ll}]{1,8})(\\s([\\p{Lu}]|[\\p{Lu}][\\p{Ll}]{1,10})){0,5}$";
    private static final String REGEXCODE = "^KH-[0-9]{4}$";
    ...
    public boolean checkName(String name) {
        return name.matches(REGEXCUSTOMER) ? true : false;
    }
